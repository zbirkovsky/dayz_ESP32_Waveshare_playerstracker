...
$output = & C:\Espressif\python_env\idf5.5_py3.11_env\Scripts\python.exe C:\Espressif\frameworks\esp-idf-v5.5.1\tools\idf.py build 2>&1
$output | Out-File -FilePath C:\DayZ_servertracker\build_log.txt -Encoding UTF8
$output
